/*
control 1 GPIO pin via any same LAN with ESP8266 devices has web browser
enter the ESP8266's IP into browser and control
output GPIO5
original author: https://hocarm.org/dieu-khien-den-hoc-qua-website-voi-esp8266/
*/
