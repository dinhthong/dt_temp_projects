...
// Thong so Wifi
const char* ssid = "TP-LINK_DECE";      //Ten wifi nha ban
const char* password = "58076439";   //Mat khau wifi nha ban
// Host
const char* host = "https://maker.ifttt.com/trigger/testne/with/key/bZX19sei2Nz7tKF3vKuBwxRoZlla-0n6q-BNWCme9_R"; //Trang web de lay du lieu
void setup() {
// Khoi dong Serial
  Serial.begin(115200);
  delay(10);
